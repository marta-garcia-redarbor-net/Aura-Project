...
A checkpoint value MUST contain exactly two fields: a nullable cursor/deltaToken (string)
and a nullable processed-at timestamp (DateTimeOffset). Both fields MAY be null
simultaneously. No other fields are part of the checkpoint value contract.

#### Scenario: Full value is stored and returned unchanged

- GIVEN cursor="delta-abc" and processedAt=2026-06-18T10:00:00Z
- WHEN saved and then retrieved by identity
- THEN cursor="delta-abc" and processedAt=2026-06-18T10:00:00Z are returned

#### Scenario: Null fields are preserved

- GIVEN a checkpoint with cursor=null and processedAt=2026-06-18T08:00:00Z
- WHEN retrieved
- THEN cursor=null and processedAt=2026-06-18T08:00:00Z are returned exactly
