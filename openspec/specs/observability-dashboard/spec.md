...
Provide real-time telemetry visibility (logs, metrics, traces) inside Aura.UI using in-process ring buffers and SignalR streaming. No external exporters or persistent storage — all data lives in bounded memory structures.
